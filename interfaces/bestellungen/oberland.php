...
$mailstatus = wp_mail( array("timothy@kpunkt.ch", "dario.vareni@hispeed.ch"), "Neue Bestellung von {$_POST["fname"]} {$_POST["lname"]}", $message, array('Content-Type: text/html; charset=UTF-8'));
